...
var sentences = [["Je suis Adrien Trahan, un développeur qui code autant en front-end qu'en back-end. J'adore coder proprement et construire des interfaces attirantes.", "I'm Adrien Trahan, a developer who codes in front-end and in back-end. I love to code properly and to build some responsive interfaces."], ["J'ai gagné le hackathon de la polytechnique en 2017. J'ai gagné une bourse d'étude à la Polytechnique en 2018.", "I won the hackathon from polytechnique in 2017. I won a bourse from polytechnique in 2018."], ["Je code en Html/Css/Js, Swift, Python, Java et en NodeJs. <br> Je suis famillier avec npm, git, pip, cocoa pod et les requests aux serveurs. <br><br>J'ai créé un système pour gèrer des compagnies, ainsi qu'un réseau social de messages pour ma classe. J'ai créé un app d'anti-ronflement et un api pour avoir des infos sur des musiques.<br><br> Je suis interessé par l'informatique, les arts, les langues, les sciences en générales et les maths.", "I'm coding in Html/Css/Js, Swift, Python, Java and in NodeJs. <br> I'm familiar with npm, git, pip, cocoa pod and with requests to servers. <br><br>I created a system to manage compagnies, I also created a social messaging app for my class. I created an anti-snoring app and an api to retrieve infos from musics.<br><br> Je suis interessé par l'informatique, les arts, les langues, les sciences en générales et les maths."], ["Suivez moi sur <span onclick='window.location = 'https://github.com/AdrienTrahan''>Github</span>, <span onclick='window.location = 'https://stackoverflow.com/users/11266658/adrien-trahan''>Stackoverflow</span> ou envoyez-moi un <a href='mailto:com.adrien.trahan@gmail.com'>email</a> !", "Follow me on <span onclick='window.location = 'https://github.com/AdrienTrahan''>Github</span>, <span onclick='window.location = 'https://stackoverflow.com/users/11266658/adrien-trahan''>Stackoverflow</span> or send me an <a href='mailto:com.adrien.trahan@gmail.com'>email</a> !"], ["<h1 class='left'>Créé avec plaisir par Adrien Trahan</h1><h1 class='right'>Copyright 2019</h1>", "<h1 class='left'>Created with pleasure by Adrien Trahan</h1><h1 class='right'>Copyright 2019</h1>"]]; // change languages
...
function scroll() {
  ...
  if (draw > 0.15) {
    document.getElementsByClassName("dot")[0].style.width = "200%";
    document.getElementsByClassName('indicator')[0].style.color = "white";
    document.getElementsByClassName("dot")[0].style.height = "200%";
